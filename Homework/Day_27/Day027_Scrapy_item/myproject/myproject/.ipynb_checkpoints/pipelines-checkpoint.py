...
class JSONPipeline(object):
    def open_spider(self, spider):                               #當爬蟲開啟時需要處理的流程 (e.g. 檢查資料庫是否可用)
    ...
    def process_item(self, item, spider):                        #每個 Item Pipeline 都需要實作，用來檢查資料數據與是否丟棄等決定
        # 把資料轉成字典格式並寫入文件中
    ...
    def close_spider(self, spider):                              #當爬蟲關閉時需要處理的流程 (e.g. 關閉資料庫連線)
