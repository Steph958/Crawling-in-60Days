...
class PttcrawlerSpider(scrapy.Spider):
    name = 'PTTCrawler'
    urls=['https://www.ptt.cc/bbs/Gossiping/M.1617236430.A.0AF.html',
          'https://www.ptt.cc/bbs/Gossiping/M.1617236799.A.A44.html'
         ]
    def __init__(self,start_urls=urls,filename=None):
    ...
    def start_requests(self):
        for url in self.start_urls:
            yield scrapy.Request(url=url, callback=self.parse_article, cookies=self.cookies)
